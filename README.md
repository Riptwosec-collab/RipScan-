...
- วางภาพจาก Clipboard ด้วยปุ่มหรือ `Ctrl+V` / `⌘+V`
- ปรับภาพเอียง เพิ่ม Contrast ลด Noise และ Threshold อัตโนมัติ
- ทดลอง OCR หลายรูปแบบและเลือกผลที่มีคะแนนดีที่สุด
- หน้า Review แบบภาพต้นฉบับคู่กับข้อความ แยกทีละหน้า
- สลับภาพต้นฉบับ/ภาพที่ใช้ OCR, Zoom, Fit และหมุน 90 องศา
- แก้ข้อความ ค้นหา Undo/Redo คัดลอก และดาวน์โหลด TXT
